...
//        std::cout << Speed << endl;
//        auto vehicleCommandInterface = getVehicleCommandInterface();
//        Acc = vehicleCommandInterface->getAcceleration();
//        std::cout << " acceleration: " << Acc << " m/s^2" << std::endl;
...
//veins::TraCICommandInterface::Vehicle* veins::VeinsInetMobility::getVehicleCommandInterface() const
//{
